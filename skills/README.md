...
- [`hardening-ci-delivery`](hardening-ci-delivery/SKILL.md) — CI, runner, artifact, release, deployment, or rerun failures; preserve test acceptance while making delivery resilient.
